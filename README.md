<div align="center">
  ...
  <h3 align="center">Real Time Figma Clone</h3>
   ...
   <div align="center">
     I learned and built this project using tutorials. You can also build this project step by step with this detailed tutorial on <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> YouTube.
    </div>
</div>
...
```bash
git clone https://github.com/jaluiovilash/figma-clone.git
cd figma-clone
```
